...
def get_item2vec_problem(problem_id, submits):
    # 저장된 모델 불러오기
    model = Word2Vec.load("/Users/im_jungwoo/Desktop/project/RecBOJ/ChromeExtension/server/models/item2vec/word2vec_model.bin") 
    with open('/Users/im_jungwoo/Desktop/project/RecBOJ/ChromeExtension/server/data/ProblemDict.json', 'r') as f:
        ProblemDict = json.load(f)
    with open('/Users/im_jungwoo/Desktop/project/RecBOJ/ChromeExtension/server/data/ProblemTagsDict.json', 'r') as f:
        TagDict = json.load(f)
    with open('/Users/im_jungwoo/Desktop/project/RecBOJ/ChromeExtension/server/data/level_to_tier.json', 'r') as f:
